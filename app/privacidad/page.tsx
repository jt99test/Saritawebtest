      ...
      <section className="relative py-7 sm:py-14">
        <Container className="min-h-[100svh] sm:min-h-screen">
          ...
          <div className="mx-auto mt-9 max-w-3xl sm:mt-14">
            ...
            <p className="mt-4 text-sm leading-7 text-[#3a3048] sm:mt-5 sm:text-base sm:leading-8">{dictionary.legal.privacyIntro}</p>
            ...
            <div className="mt-10 space-y-8 border-t border-black/10 pt-8">
              {dictionary.legal.privacySections.map((section) => (
