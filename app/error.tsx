        ...
        <section className="max-w-2xl border border-white/10 bg-white/[0.03] px-6 py-10 text-center shadow-[0_24px_90px_rgba(0,0,0,0.35)] sm:px-10">
          ...
          <div className="mt-8 flex flex-wrap items-center justify-center gap-4">
            <button
              ...
              className="rounded-full border border-dusty-gold/35 bg-dusty-gold/12 px-5 py-3 text-xs font-semibold uppercase tracking-[0.22em] text-dusty-gold/88 transition hover:border-dusty-gold/60 hover:bg-dusty-gold/18"
            >
              {dictionary.common.tryAgain}
            </button>
            <Link
              href="/"
              className="px-5 py-3 text-xs font-semibold uppercase tracking-[0.22em] text-ivory/56 transition hover:text-ivory"
            >
