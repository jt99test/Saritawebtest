      ...
      <section className="relative py-4 sm:py-8">
        <Container className="relative">
          <div className="mb-4 flex items-center justify-between gap-4 pt-2 sm:mb-6">
            <Link href="/yoga-astral" className="text-[10px] font-medium uppercase tracking-[0.18em] text-[#d7e7ff]/72 transition hover:text-ivory sm:text-xs sm:tracking-[0.28em]">
          ...
          {!result?.chart ? (
            <div className="flex min-h-[70vh] items-center justify-center text-center">
              <div>
                <p className="font-serif text-[13px] italic lowercase tracking-[0.15em] text-[#f5d782]">{dictionary.yogaAstral.title}</p>
            ...
            <PaidFeatureGate dictionary={dictionary} featureName={dictionary.yogaAstral.title}>
              ...
              <header className="border-t border-[rgba(181,163,110,0.15)] pt-6 sm:pt-8">
                <p className="text-[12px] font-semibold uppercase tracking-[0.3em] text-[#f5d782]">{dictionary.yogaAstral.title}</p>
              ...
              <footer className="flex flex-col items-start justify-between gap-4 border-t border-[#d7e7ff]/12 pt-6 sm:flex-row sm:items-center">
                <Link href="/yoga-astral" className="text-[10px] font-medium uppercase tracking-[0.18em] text-[#d7e7ff]/72 transition hover:text-ivory sm:text-xs sm:tracking-[0.24em]">
                  {dictionary.form.back} · {dictionary.result.primaryTabs.yoga}
                </Link>
