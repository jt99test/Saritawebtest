...
export function AstrocartographyPage({ chart, request = null, dictionary, readingId, gender }: AstrocartographyPageProps) {
  ...
  return (
    <section className="mx-auto max-w-6xl overflow-hidden py-7 sm:py-10">
          ...
          {PLANETS.map((planet) => {
            ...
            return (
              <button
                ...
                className={[
                  "shrink-0 rounded-full border px-3 py-2 text-[10px] font-semibold uppercase tracking-[0.12em] transition sm:text-[11px] sm:tracking-[0.16em]",
          ...
          {ANGLES.map((angle) => {
            ...
            return (
              <button
                ...
                className={[
                  "rounded-full border px-3 py-2 text-[10px] font-semibold uppercase tracking-[0.14em] transition sm:px-4 sm:text-[11px] sm:tracking-[0.18em]",
      ...
      <div className="mt-8 grid gap-4 lg:grid-cols-[0.9fr_1.1fr]">
          ...
          {selectedLine ? (
            <>
              <div className="mt-3 flex items-start justify-between gap-4">
                <div>
                  <h3 className="break-words font-serif text-[24px] leading-tight text-ivory sm:text-[28px]">
        ...
        <article className="border border-black/10 bg-white p-5 shadow-[0_10px_30px_rgba(0,0,0,0.07)]">
          ...
          <h3 className="mt-2 break-words font-serif text-[24px] leading-tight text-ivory sm:text-[28px]">
      ...
      <article className="mt-4 overflow-hidden border border-black/10 bg-white p-5 shadow-[0_10px_30px_rgba(0,0,0,0.07)] sm:p-6">
            ...
            {isLoadingReading ? (
              ...
              <div className="mt-3">
                <h4 className="break-words font-serif text-[21px] leading-snug text-ivory sm:text-[22px]">{reading.summaryTitle}</h4>
