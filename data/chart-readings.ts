...
function fallbackCopy(dictionary: Dictionary) {
  ...
  if (locale === "en") {
    return {
      ...
      ascLead: (sign: string) => `${dictionary.result.generalReading.cards.ascendant.paragraphs[0]} The Ascendant in ${sign} shows the first way the chart meets life.`,
  ...
  if (locale === "it") {
    return {
      ...
      ascLead: (sign: string) => `${dictionary.result.generalReading.cards.ascendant.paragraphs[0]} L'Ascendente in ${sign} mostra il primo modo in cui la carta entra in contatto con la vita.`,
  ...
  return {
    ...
    ascLead: (sign: string) => `${dictionary.result.generalReading.cards.ascendant.paragraphs[0]} El Ascendente en ${sign} muestra la primera forma en que la carta entra en contacto con la vida.`,
